...
async def detailed_health_check(auth: AuthContext = Depends(get_auth_context)):
    ...
    try:
        ...
        system_status = status_service.get_comprehensive_status()
        ...
        return APIResponse(
            ...
            data={
                ...
                "service": "BeautyAI Inference API",
                "version": "1.0.0", 
                "system": system_status.to_dict() if hasattr(system_status, 'to_dict') else vars(system_status),
...
async def readiness_check():
    ...
    try:
        ...
        try:
            # Simple health check - just verify service is responsive
            health_status = status_service.get_health_status()
